...
describe 'A Diakonos::Buffer' do
  ...
  before do
    @b = Diakonos::Buffer.new( SAMPLE_FILE, SAMPLE_FILE )
  end
  ...
  it 'knows indentation level' do
    ...
    b2 = Diakonos::Buffer.new( indentation_file, indentation_file )
    indentation_file = File.join( TEST_DIR, 'indentation.test2' )
    b3 = Diakonos::Buffer.new( indentation_file, indentation_file )
  ...
  it 'can indent smartly' do
    ...
    @b = Diakonos::Buffer.new( SAMPLE_FILE_C, SAMPLE_FILE_C )
