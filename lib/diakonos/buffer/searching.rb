module Diakonos
  ...
  class Buffer
    ...
    def establish_finding( regexps, from_row, from_col, match )
      found_text = match[ 0 ]
    ...
    def find( regexps, options = {} )
      ...
      match = nil
        ...
        if direction == :down
          ...
          if index
            finding = establish_finding( regexps, from_row, index, Regexp.last_match )
      ...
      # if finding && ! (
        ...
        # search_area.contains?( finding.end_row, finding.end_col )
      # )
        # finding = nil
      # end
